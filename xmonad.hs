...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    [ ((modm .|. shiftMask, xK_Return), spawn $ XMonad.terminal conf)
	  ...
	  -- custom additions
		-- launch info screen
		, ((modm .|. shiftMask, xK_i), spawn "startinfo")

		-- enable virtual scroll wheel
		...
		-- launch ncmpcpp
		, ((modm .|. shiftMask, xK_n), spawn "urxvt +sb -bg black -fg white -e 'ncmpcpp'")

		-- launch urxvt with black-on-white instead
		, ((modm .|. shiftMask, xK_l), spawn "cd /home/b2coutts; urxvt +sb -bg white -fg black -fn 'xft:Liberation Mono:pixelsize=14'")

		-- launch chrome in incognito
		, ((modm, xK_o), spawn "google-chrome --incognito")
	...
	-- asdf
    --
     , ((modm              , xK_m     ), sendMessage ToggleStruts)
